  ...
  return (
    <div className="font-rubik flex flex-row justify-between bg-[#F8F8F8] py-20 px-14">
      <div className="w-[45%] flex flex-col gap-y-5" >
        ...
        <p className="text-[#4F5665] text-base font-[500] leading-7">Coffee Shop is a store that sells some good meals, and especially coffee. We provide high quality beans</p>
