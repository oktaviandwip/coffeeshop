...
export default function Alert ({msg, setMsg}) {
  ...
  return (
    <div id="alert" className="fixed top-0 left-0 w-screen h-screen flex flex-row justify-center items-center bg-[#000000CC] transition-all ease-linear duration-300">
