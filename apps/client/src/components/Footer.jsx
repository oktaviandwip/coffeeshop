  ...
  return (
    <footer className="relative font-rubik flex flex-row justify-between bg-[#F8F8F8] py-20 px-40 pt-40 -z-20">
      <div className="flex flex-col gap-y-5" >
        ...
        <p className="w-1/2 text-[#4F5665] text-base font-[500] leading-7">Coffee Shop is a store that sells some good meals, and especially coffee. We provide high quality beans</p>
        <div className="flex flex-row gap-x-4">
            <a href="" className="flex flex-row bg-brown rounded-full border border-brown"><img className="" src={iconFb} alt="" /></a>
            <a href="" className="flex flex-row bg-brown rounded-full border border-brown"><img className="" src={iconTwitter} alt="" /></a>
            <a href="" className="flex flex-row bg-brown rounded-full border border-brown"><img className="" src={iconIg} alt="" /></a>
        </div>
